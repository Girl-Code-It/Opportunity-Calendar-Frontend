...
class HackathonsForm extends Component {
  ...
  handleSubmit = (event) => {
    ...
    alert(
      `${this.state.title} ${this.state.url} ${this.state.date} ${this.state.description} ${this.state.location} ${this.state.description} ${this.state.location} ${this.state.eligibility} ${this.state.deadline} ${this.state.image}`
    );
    this.setState({
      title: "",
      url: "",
  ...
  render(){
      const { title, url, date, description, location, eligibility, deadline, image } = this.state;
